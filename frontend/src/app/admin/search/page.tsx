                    ...
                    <tr key={item.id}>
                      ...
                      <td>
                        {item.image_path ? (
                          ...
                          >
                            <img loading="lazy" src={getThumbnailUrl(item.image_path)} alt="Thumb" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                          </div>
                        ) : (
                      ...
                      <td>
                        <span style={{ display: 'inline-flex', alignItems: 'center', gap: '5px' }}>
                          ...
                          {item.source_type === 'camera' && (
                            item.camera_name
                              ? <><i className="fa-solid fa-video" style={{ color: '#fbbf24' }}></i> {item.camera_name}</>
                              : <><i className="fa-solid fa-video" style={{ color: '#fbbf24' }}></i> Camera</>
                          )}
                        </span>
                      </td>
                      <td>{formattedTime}</td>
